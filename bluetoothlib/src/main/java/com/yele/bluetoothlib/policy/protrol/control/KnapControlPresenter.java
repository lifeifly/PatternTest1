 ...
 */
public class KnapControlPresenter extends BaseBleControl implements INormalSet {

    public KnapControlPresenter(Context context, OkDevice okDevice) {
    ...
    private void init() {
        ...
        REPORT_CHANNEL = BLEUUIDs.KNAP_REPORT_CHANNEL;
        UPGRADE_CHANNEL = BLEUUIDs.KNAP_UPGRADE_CHANNEL;
    }
