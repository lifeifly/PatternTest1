...
public class UpgradeFrame {
    ...
    private boolean initFile() throws IOException {
        ...
        if (isPlanUDA) {
            ...
            packNum = ByteUtils.bytesToIntBySmall(lenBuf, 2);
        }
...
*/
    ...
    public byte[] getNowData() throws IOException {
        ...
        if (index == length) {
            if (type == TYPE_CONTROL) {
                ...
                return packIndexMCU(new byte[MAX_DATA_LEN]);
            }
        ...
        if (buff.length < MAX_DATA_LEN) {
            ...
            if (type == TYPE_CONTROL) {
                ...
                return packIndexMCU(data);
            }
        } else {
            if (type == TYPE_CONTROL) {
                return packIndexControl(buff);
            }else{
                return packIndexMCU(buff);
            }
        }
    }
    ...
    public int getPercent() {
        ...
        long all = packNum * 1024 / MAX_DATA_LEN;
        return (int) (packIndex * 100 / all);
    }
    ...
    private byte[] packIndexControl(byte[] buff) {
        ...
        data[8] = ByteUtils.intToUnitByte((int) packIndex);
