...
public class BLEUUIDs {
	...
	// 普通仪表使用的特征通道的码
	public static final String CAR_COMMON_CHANNEL = "00002c01-0000-1000-8000-00805f9b34fb";			// 普通发送的数据通道
	public static final String CAR_REPORT_CHANNEL = "00002c03-0000-1000-8000-00805f9b34fb";			// 报告的信道
	public static final String CAR_UPGRADE_CHANNEL = "00002c01-0000-1000-8000-00805f9b34fb";	// 更新固件的数据通道
...
//	public static final String TEST_SERVICE_UUID = "10002C0a-0000-1000-8000-00805f9b34fb";		// 测试服务的UUID，用于发送数据
//	public static final String TEST_SERVICE_UUID = "8653000a-43e6-47b7-9cb0-5fc21d4ae340";		// 测试服务的UUID，用于发送数据
//	public static final String COMMON_CHANNEL = "10002C0b-0000-1000-8000-00805f9b34fb";			// 普通发送的数据通道
//	public static final String COMMON_CHANNEL = "8653000b-43e6-47b7-9cb0-5fc21d4ae340";			// 普通发送的数据通道
//	public static final String QR_CODE_CHANNEL = "00002c02-0000-1000-8000-00805f9b34fb";			// 发送二维码的数据通道
//	public static final String QR_CODE_CHANNEL = "10002C0c-0000-1000-8000-00805f9b34fb";			// 发送二维码的数据通道
//	public static final String QR_CODE_CHANNEL = "8653000c-43e6-47b7-9cb0-5fc21d4ae340";			// 发送二维码的数据通道
//	public static final String REPORT_CHANNEL = "86532c0c-43e6-47b7-9cb0-5fc21d4ae340";			// 发送二维码的数据通道

	public static final String PART_COMMON_CHANNEL = "00002c05-0000-1000-8000-00805f9b34fb";	// 配件的普通数据发送通道
	public static final String PART_REPORT_CHANNEL = "00002c06-0000-1000-8000-00805f9b34fb";	// 配件的上报数据通道
	public static final String PART_UPGRADE_CHANNEL = "00002c05-0000-1000-8000-00805f9b34fb";	// 配件的更新数据通道
	public static final String PART_CONFIG_CHANNEL = "00002C10-0000-1000-8000-00805f9b34fb";			// 更新固件的数据通道

	public static final String KNAP_COMMON_CHANNEL = "00002c07-0000-1000-8000-00805f9b34fb";	// 配件的普通数据发送通道
	public static final String KNAP_REPORT_CHANNEL = "00002c08-0000-1000-8000-00805f9b34fb";	// 配件的上报数据通道
	public static final String KNAP_UPGRADE_CHANNEL = "00002c07-0000-1000-8000-00805f9b34fb";	// 配件的更新数据通道
	public static final String KNAP_CONFIG_CHANNEL = "00002C10-0000-1000-8000-00805f9b34fb";	// 更新固件的数据通道
}
