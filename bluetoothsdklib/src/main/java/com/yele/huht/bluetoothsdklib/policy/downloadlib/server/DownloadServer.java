...
//                    LogUtils.i(TAG, "加载文件大小成功");
    ...
    private void createForNoti() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel = new NotificationChannel("123", "下载工具后台服务",
            ...
            Notification notification = new Notification.Builder(this).setChannelId("123")
                    .setTicker("Nature")
                    .setContentTitle("下载工具后台服务")
                    .setContentText("下载工具后台服务")
