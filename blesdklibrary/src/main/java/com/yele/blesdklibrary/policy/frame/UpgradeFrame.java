package com.yele.blesdklibrary.policy.frame;
...
public class UpgradeFrame {
    ...
    private int packIndex = 0;      // 当前发送的包得坐标（第几个包）
    ...
    private byte[] packIndex(byte[] buff) {
        ...
        logI(TAG,ByteUtils.bytesToStringByBig(data));
        return data;
    }
